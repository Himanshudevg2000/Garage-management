...
const Login = () => {
    return (
        <div class="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl my-12">
            <div class="hidden bg-cover bg-center lg:block lg:w-1/2" style={{ backgroundImage: "url('/image/car-img.jpg')", }}></div>
            ...
            <div class="w-full px-6 py-8 md:px-8 lg:w-1/2">
                ...
                <h1 class="mt-1 text-xl text-center text-gray-600 dark:text-gray-200">User Login</h1>
                ...
                <div class="flex items-center justify-between mt-4">
                    ...
                    <Link href="/auth/register" class="text-xs text-gray-500 uppercase dark:text-gray-400 hover:underline">or Register</Link>
